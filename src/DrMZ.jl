...
export advection_pde!, advection_diffusion_pde!, inviscid_burgers_pde!, viscous_burgers_pde!,
       ...
       quadratic_nonlinear,
       quadratic_nonlinear_opnn, quadratic_nonlinear_opnn_pseudo, second_derivative_opnn,
       generate_fourier_solution,
       generate_basis_solution, generate_basis_solution_nonlinear,
       backward_upwind, forward_upwind, backward_upwind_limited, forward_upwind_limited,
       ...
       generate_bwlimitersoupwind_solution
...
export basis_OpNN, build_basis, build_basis_redefinition,
       ...
       quadratic_nonlinear_triple_product, second_derivative_product,
       save_basis,
       orthonormal_check
